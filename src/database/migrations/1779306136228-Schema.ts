...
/**
 * Single generated migration for the full application schema (replaces
 * InitialSchema, PostInitialSchema, and all prior incremental migrations).
 * Requires a fresh database: run `pnpm db:reset` or drop schema before deploy.
 */
export class Schema1779306136228 implements MigrationInterface {
  name = 'Schema1779306136228';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "uploaded_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "file_name" character varying(255) NOT NULL, "file_size_bytes" bigint NOT NULL, "file_type" character varying(50) NOT NULL, "status" "public"."uploaded_documents_status_enum" NOT NULL DEFAULT 'uploading', "percent_complete" integer NOT NULL DEFAULT '0', "storage_path" text NOT NULL, "parsed_text" text, "failure_reason" character varying(200), CONSTRAINT "PK_6bd36c941b6c6187ac74ded1ca8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "funnels" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "business_name" character varying(255) NOT NULL DEFAULT 'My Business', "creation_path" "public"."funnels_creation_path_enum" NOT NULL DEFAULT 'wizard', "status" "public"."funnels_status_enum" NOT NULL DEFAULT 'generating', "idempotency_key" character varying(255) NOT NULL, "business_context" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_d4a12f72b8c7eb9074e20a415da" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "stage_tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "stage_id" uuid NOT NULL, "task_text" text NOT NULL, "name" character varying(255) NOT NULL, "is_complete" boolean NOT NULL DEFAULT false, "completed_at" TIMESTAMP WITH TIME ZONE, "position" integer NOT NULL, "status" "public"."stage_tasks_status_enum" NOT NULL DEFAULT 'pending', CONSTRAINT "PK_a9c5f0fa5f644c76b5322b2034b" PRIMARY KEY ("id"))`);
