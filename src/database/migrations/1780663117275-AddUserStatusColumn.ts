...
export class AddUserStatusColumn1780663117275 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "users_plan_check"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c07cffb34f4e05a78f7663bc61" ON "admin_notifications" ("admin_id") `);
