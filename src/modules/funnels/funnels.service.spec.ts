...
function createMockQB(returnValues: any = {}) {
  const qb: any = {
    calls: [],
    where() {
      this.calls.push(['where', Array.from(arguments)]);
      return this;
    },
    orderBy() {
      this.calls.push(['orderBy', Array.from(arguments)]);
      return this;
    },
    addOrderBy() {
      this.calls.push(['addOrderBy', Array.from(arguments)]);
      return this;
    },
    leftJoinAndSelect() {
      this.calls.push(['leftJoinAndSelect', Array.from(arguments)]);
      return this;
    },
    select() {
      this.calls.push(['select', Array.from(arguments)]);
      return this;
    },
    addSelect() {
      this.calls.push(['addSelect', Array.from(arguments)]);
      return this;
    },
    groupBy() {
      this.calls.push(['groupBy', Array.from(arguments)]);
      return this;
    },
    skip() {
      this.calls.push(['skip', Array.from(arguments)]);
      return this;
    },
    take() {
      this.calls.push(['take', Array.from(arguments)]);
      return this;
    },
...
describe('FunnelsService', () => {
  ...
  it('AC-05 - getStageDetail returns a full stage payload when unlocked', async () => {
    ...
    taskRepo.createQueryBuilder.mockReturnValue(
      createMockQB({
        stages: [{ id: 't1', position: 1, name: 'Task 1', status: 'complete' }],
        rawOne: { total: 1, complete: 1 },
      }),
    );
